...
<?php
  ...
  if(isset($_POST['btnsave'])){
    $title = $_POST['title'];
          ...
          $check_qry = mysqli_query($my_connection, "SELECT   `title` FROM `departments` WHERE  title = '$title'") or die (mysqli_error($my_connection));
 $num_rows = mysqli_num_rows($check_qry); 
if($num_rows == 0){
 $insert_qry = "INSERT INTO `departments`(`title`)  VALUES ('$title')"; 
...
$(".city").html(html);
            ...
            <div class="container">
                ...
                <div class="row">
                    <div class="col-sm-12">
                        ...
                        <h4 class="page-title">Add Court/Office/Other</h4>
                        <ol class="breadcrumb">
   ...
   <form class="" role="form" method="post" enctype="multipart/form-data">
                                      ...
                                      <div class="form-group col-md-4">
                                            ...
                                            <div class="">
                                                <input type="text" class="form-control" placeholder="Court/Office/Other Name" name = "title" required />
                                            </div>
                                        </div>
                ...
                <div class="row">
                    <div class="col-sm-12">
                        <div class="card-box table-responsive">
                            <h4 class="m-t-0 header-title"><b>Court/Office/Other List</b></h4>
                 ...
                 <?php 
                   ...
                   $today = date("Y-m-d");
 $select_qry2 = mysqli_query($my_connection, "select * from departments") or die(mysqli_error($my_connection));
                                $n = 1;
                             ...
                             echo ' <tr role="row" class="odd">';
                                   ...
                                   echo ' <a href="#" >  
                             <a  href ="department_edit.php?id='.$id.'" data-toggle="tooltip" data-placement="bottom" title="Edit" style=""> 

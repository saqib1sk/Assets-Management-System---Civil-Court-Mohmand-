...
<?php
  ...
  if(isset($_POST['btnsave'])){
   // echo 'here is  me'; die();
    ...
    //die();
$check_qry = mysqli_query($my_connection, "select mobile from employees where mobile = '$mobile'") or die (mysqli_error($my_connection));
...
$target_dir = "employee_images/";
 if(@$_FILES["upload_file"]["name"][0] != null){
   ...
   $path = $target_dir.$file_new_name;
     ...
     $insert_qry = "INSERT INTO `employees`(`department_id`, `name`, `mobile`, `cnic`, `email`, `designation`, `image_path`)
                                   VALUES ('$department_id','$name','$mobile','$cnic','$email','$designation','$path')"; 
 ...
 $warning = '<div class="alert alert-danger alert-block alert-dismissible fade in iconic-alert" role="alert">
        ...
        $insert_qry1 = "INSERT INTO `employees`(`department_id`, `name`, `mobile`, `cnic`, `email`, `designation`, `image_path`)
                              VALUES ('$department_id','$name','$mobile','$cnic','$email','$designation','IMAGE NOT YET ADDED')"; 
                ...
                <div class="row">
                    <div class="col-sm-12">
                        <div class="card-box table-responsive">
                            <h4 class="m-t-0 header-title"><b>Employees List</b></h4>
...
// JOIN table2 t2 ON t1.common_column = t2.common_column;
 ...
 $select_qry2 = mysqli_query($my_connection, "select emp.*,d.title as department_name from employees  emp 
                                              join 
                                              departments as d
                                              on emp.department_id = d.id ") or die(mysqli_error($my_connection));
                                $n = 1;
          ...
          <a href="#"> <img class="media-object img-circle" alt="Image Not yet Added" src="'.$row2['image_path'].'" style="width: 74px; height: 74px;"> </a>
                             ...
                             <a  href ="employee_edit.php?id='.$id.'" data-toggle="tooltip" data-placement="bottom" title="Edit" style=""> 

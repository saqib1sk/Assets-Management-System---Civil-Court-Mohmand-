    ...
    <body>
        ...
        <div class="wrapper">
            <div class="container">
                ...
                <div class="row">
                    <div class="col-sm-12">
                        <h4 class="page-title">Court Register  List</h4>
                        <ol class="breadcrumb">
                        </ol>
                    </div>
                </div>
                ...
                <div class="row">
                    <div class="col-sm-12">
                        <div class="card-box table-responsive">
                            <h4 class="m-t-0 header-title"><b>Total Court Register  List</b></h4>
...
//                                               where ai.category_id = 3
 ...
 WHERE aa.category_id = 3") or die(mysqli_error($my_connection));
                                $n = 1;

...
require_once('my_connection.php');
    ...
    if(isset($_GET['id'])){
         $id = $_GET['id'];
       //echo $id;
    $select_qry = mysqli_query($my_connection, "SELECT * FROM `departments` where id = $id") or die(mysqli_error($my_connection));
...
?>
 <?php if(isset($_POST['btnupdate'])){
     $title = $_POST['title'];
        ...
        $update_query = mysqli_query($my_connection,"UPDATE `departments` SET `title`='$title'  WHERE id = '$id'") or die (mysqli_error($my_connection));
    
   
     echo "<script>
    window.location = 'department_add.php?msg=updated';
</script>"; 
...
<?php require_once('my_meta.php'); ?>
            ...
            <div class="container">
                ...
                <div class="row">
                    <div class="col-sm-12">
                        ...
                        <h4 class="page-title">Update Court/Office/Other</h4>
                        <ol class="breadcrumb">
   ...
   <form class="" role="form" method="post" enctype="multipart/form-data">
                                      ...
                                      <div class="form-group col-md-4">
                                            ...
                                            <div class="">
                                                <input type="text" class="form-control" placeholder="Enter Court/Office/Other Name" name = "title" value="<?php echo $title; ?>" required />
                                            </div>
                                        </div>

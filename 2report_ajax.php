...
if (isset($_POST['from_date_a']) && isset($_POST['to_date_a']) && isset($_POST['category_a']) && isset($_POST['departments_a']) && isset($_POST['item_a'])) {
    ...
    $departments_a   = $_POST['departments_a'];
    $item_a   = $_POST['item_a'];
...
<div class="row">
          ...
          <small style="margin-left: 50px;">Email: <span style = "text-transform: lowercase">scjmohmand@gmail.com</span> - Tel: 0924-290145   </small>     
...
if($category_a=='All' && $departments_a =='All' && $item_a=='All'){
...
}elseif($departments_a =='All' && $item_a=='All'){
...
WHERE 
  ...
  AND c.id = '$category_a';") or die(mysqli_error($my_connection));
...
elseif($category_a=='All' && $departments_a =='All'){
...
if (isset($_POST['c_from_date']) && isset($_POST['c_to_date']) && isset($_POST['category_id']) && isset($_POST['item_a'])) {
    $get_from_date = $_POST['c_from_date'];
    $get_to_date   = $_POST['c_to_date'];
    $category_id   = $_POST['category_id'];
    $item_cat = $_POST['item_a'];
...
<div class="row">
          ...
          <small style="margin-left: 50px;">Email: <span style = "text-transform: lowercase">scjmohmand@gmail.com</span> - Tel: 0924-290145   </small>     
            ...
            <h3><small><strong>Supply / Invoice List (<?php if($title != ' '){ echo @$title; } else { } ?>  )</strong></small></h3> 
...
JOIN asset_available aa ON iad.available_asset_id = aa.id
join items i on aa.item_id = i.id
where  aa.item_id = '$item_cat' AND ia.demand_date BETWEEN '$from_date' AND '$to_date';") or die(mysqli_error($my_connection));
}

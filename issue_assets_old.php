  ...
  $.ajax({
    ...
    data: {
      ...
      success: function(result) {
        $("#current_qty"+id).html(result.field);
...
// }
   ...
   <form class="" role="form" method="post" enctype="multipart/form-data">
                                        ...
                                        <div class="row">
                                            ...
                                            <label class=" control-label">Demand/Report No</label>
             ...
             <?php $select_qry = mysqli_query($my_connection,"select d.* from departments d ") or die (mysqli_error($my_connection)); 
                                          ...
                                          <div class="form-group col-md-3">
                                            <label class=" control-label">Select Receiver Name & Designation</label>
                                            <div class="">
    ...
    <div class="" style="" id="edu_new_row">
                        ...
                        <input type="hidden" name="row[]" value="1">
                                        ...
                                        <div class="form-group col-md-3">
                                            ...
                                            <div class="">
                                            <select name="item_id[]" class="form-control item" id="item_id1" onchange="get_asset_quantity(1),get_category_id(1)">
             ...
             <?php $select_qry = mysqli_query($my_connection,"select aa.*,i.item_name from asset_available aa 
                                     ...
                                     <!--    <div class="form-group col-md-2" style="display:block;">
                                            ...
                                            <div class="category_id" id="category_id1">

                                            <input type="number" class="form-control category_id" id="category_id1"  name="category_id[]" />
...
//                 OLD Query ->   select ia.*,i.item_name,d.title,e.name from issue_assets ia 
//  join assets a on ia.assets_id = a.id
//  join departments d on ia.department_id = d.id
//  join employees e on ia.employee_id = e.id
              
 $select_qry2 = mysqli_query($my_connection, "select ia.*,iad.quantity_issue,iad.available_asset_id,d.title  department,e.name employee,e.designation,aa.category_id,c.title as category_title,i.item_name from issue_assets ia 
 ...
 ") or die(mysqli_error($my_connection));
                             ...
                             echo ' <tr role="row" class="odd">';
                                    ...
                                    echo '<td> '.$n++.'</td>';
                                     ...
                                     echo  '<td class="">';
                                    echo '<b>'.$row2['demand_report_no'].'</b>';
                                    echo '</td>';
                                   ...
                                   //   echo '<b>'.$row2['item_name']. '<br><span style="color: #81c868;"> ID : </span>'.$row2['item_id'].' </b>';
                                    ...
                                    echo  '<td class="">';
                                    echo '<b>'.$row2['employee']. '<br><span style="color: #81c868;">Designation : </span>'.$row2['designation'].'</b>';
                                    echo '</td>';

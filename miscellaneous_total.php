...
<?php require_once('my_meta.php'); ?>
    <body>
        ...
        <div class="wrapper">
            <div class="container">
                ...
                <div class="row">
                    <div class="col-sm-12">
                        <div class="card-box table-responsive">
                            <h4 class="m-t-0 header-title"><b>Total Miscellaneous List</b></h4>
                ...
                // OLD QUERY    select a.*,s.name,c.title as category_name,i.unit,i.item_name from assets a 
 ...
 $select_qry2 = mysqli_query($my_connection, "select aa.*,c.title,i.item_name from asset_available aa
join categories c on aa.category_id = c.id
join items i on aa.item_id = i.id
WHERE aa.category_id = 2") or die(mysqli_error($my_connection));
                                $n = 1;

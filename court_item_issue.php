...
<?php require_once('my_meta.php'); ?>
    <body>
        ...
        <div class="wrapper">
            <div class="container">
                ...
                <div class="row">
                    <div class="col-sm-12">
                        <h4 class="page-title">Court Item List</h4>
                        <ol class="breadcrumb">
                        </ol>
                    </div>
                </div>
                ...
                <div class="row">
                    <div class="col-sm-12">
                        <div class="card-box table-responsive">
                            <h4 class="m-t-0 header-title"><b>Issue Court Item List</b></h4>
 ...
 WHERE ia.category_id = 3") or die(mysqli_error($my_connection));
                                $n = 1;
            ...
            <a href="#"> <img class="media-object img-circle" alt="Image Not yet Added" src="'.$row2['file_path'].'" style="width: 74px; height: 74px;"> </a>
                            ...
                            //        echo '        
                            //  <a  href ="issue_assets_edit.php?id='.$id.'" data-toggle="tooltip" data-placement="bottom" title="Edit" style=""> 
